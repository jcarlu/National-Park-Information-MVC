	...
	<div class="element">
            ...
            <g id="Cloud_6">
    	        <g id="White_cloud_6">
    		        ...
    		        <circle id="XMLID_80_" class="white" cx="17.4" cy="22.8"
									r="9.3" />
    		        <circle id="XMLID_77_" class="white" cx="34.5" cy="21.1"
									r="15.6" />
    	        </g>
    	        <g id="Gray_cloud_6">
    		        ...
    		        <circle id="XMLID_74_" class="gray" cx="45.7" cy="10.7"
									r="10.7" />
                ...
                <animate attributeType="CSS" attributeName="opacity"
									attributeType="XML" dur="1.5s" keyTimes="0;0.5;1"
									repeatCount="indefinite" values="1;0;1" calcMode="linear" />
    	        </g>
    	        <g id="Rain_6">
